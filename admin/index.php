...
<html>
	<head>
		<title>E-Sporting-Admin Panel</title>
		<link rel="stylesheet" type="text/css" href="../style.css">
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
		<script src="../js/homeslideshow.js"></script>
	</head>
	<body style="min-width: 980px; background-image: url(../image/i8.jpg);">
		...
		<div class="categolis">
			<table>
				<tr>
					<th><a href="index.php" style="text-decoration: none;color: #fff;padding: 4px 12px;background-color: #E85A4F;border-radius: 12px;">Home</a></th>
					...
					<th><a href="allproducts.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #1C3334;border-radius: 12px;">All Products</a></th>
