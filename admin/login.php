...
if (isset($_POST['login'])) {
	if (isset($_POST['email']) && isset($_POST['password'])) {
		...
		$result = mysqli_query($link,"SELECT * FROM admin WHERE (email='$user_login') AND password='$password_login'");
							...
							<div>
								<form action="" method="POST" class="registration" name="myForm">
									<div class="signup_form">
										<div>
											<td>
												<input name="email" placeholder="Enter Your Email"  required="required" class="email signupbox" type="text" size="30" >
											</td>
										</div>
										<div>
											<td>
