...
<html>
	...
	<body class="home-welcome-text" style="background-image: url(../image/i22.jpg);">
		...
		<div class="categolis">
			<table>
				<tr>
					...
					<th><a href="newadmin.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #E85A4F;border-radius: 12px;">New Admin</a></th>
